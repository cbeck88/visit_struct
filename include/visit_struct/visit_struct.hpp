...
#define VISIT_STRUCT_PP_MAP0(f, x, peek, ...) f(x) VISIT_STRUCT_INDIRECT_EXPAND(VISIT_STRUCT_PP_MAP_NEXT(peek, VISIT_STRUCT_PP_MAP1), (f, peek, __VA_ARGS__))
#define VISIT_STRUCT_PP_MAP1(f, x, peek, ...) f(x) VISIT_STRUCT_INDIRECT_EXPAND(VISIT_STRUCT_PP_MAP_NEXT(peek, VISIT_STRUCT_PP_MAP0), (f, peek, __VA_ARGS__))
#define VISIT_STRUCT_PP_MAP(f, ...) VISIT_STRUCT_PP_MAP_EVAL(VISIT_STRUCT_INDIRECT_EXPAND(VISIT_STRUCT_PP_MAP1, (f, __VA_ARGS__, (), 0)))
